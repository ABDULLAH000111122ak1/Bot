...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '489016070552944653') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '489016070552944653') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NTAyNzIyODQwOTYxNzQ0ODk4.DqsE6w.gsQctdlLR2GrWx96WSTLkKJqNwY'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '489016070552944653') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
client.on("message", message => {
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | **ليس لديك صلاحيات**');
      ...
      message.channel.sendMessage("", {embed: {
        ...
        footer: {
          text: "Riven" // غير هنا حط اسم البوت
        }
...
client.login('NTAyNzIyODQwOTYxNzQ0ODk4.DqsE6w.gsQctdlLR2GrWx96WSTLkKJqNwY'); 